 ...
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | CRLL | LAlt |       | RAlt |CtrlR |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 |Backsp|  FN  |------|       |------|  Enter |Space |
 *                                 | ace  |      | LGui |       | RGui |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,         KC_Q,         KC_W,   KC_E,    KC_R,     KC_T,   MO(MOUS),
        KC_ESC,         KC_A,         KC_S,   KC_D,    KC_F,     KC_G,
        KC_LSFT,        KC_Z,         KC_X,   KC_C,    KC_V,     KC_B,   ALL_T(KC_NO),
        MO(LGHT),           KC_QUOT,      LALT(KC_LSFT),   KC_LEFT,  KC_RGHT,
                                              KC_LCTL,           KC_LALT,
                                                                 MO(MDIA),
                                              KC_BSPC, MO(SYMB), KC_RGUI,
        // right hand
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_HASH,KC_DLR, KC_LPRN,KC_RPRN,KC_EQL,
       ...
       KC_TRNS, KC_QUOT, KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F12,
                KC_DQT,  KC_4,   KC_5,    KC_6,    KC_PLUS, KC_TRNS,
